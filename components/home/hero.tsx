...
export function Hero() {
  return (
    <section className="relative flex min-h-[92vh] items-end overflow-hidden bg-forest-dark">
      <Image
        src="https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?q=80&w=2400&auto=format&fit=crop"
        alt="Misty tea-covered hills of the Western Ghats"
        fill
        priority
      ...
      <div className="container relative z-10 pb-28 pt-40 md:pb-36">
      ...
      <div className="container relative z-10 -mb-24 md:-mb-16">
        <HeroInquiryCard />
      </div>
